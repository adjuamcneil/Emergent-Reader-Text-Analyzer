...
POS_subset = merged_npn[["word", "DPoS_Brys"]]
token_table_npn = token_table_npn.merge(POS_subset, how="inner", on="word")
topic = (
    token_table_npn.loc[token_table_npn["DPoS_Brys"]=="Noun","word"]
    .drop_duplicates()
    .head(3)
    .tolist())
#
